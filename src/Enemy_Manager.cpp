...
void Enemy_Manager::enemy_renderer(SDL_Renderer *renderer)
{
    ...
    {
        if (enemy_list[l]->EnemyDead && enemy_list[l]->DeathAnimationCounter < 30)
        {
    ...
    {
        if (big_enemy_list[l]->EnemyDead && big_enemy_list[l]->DeathAnimationCounter < 30)
        {
            big_enemy_list[l]->DeathAnimationRender(renderer);
            l++;
        }
        else if (big_enemy_list[l]->EnemyDead)
        {
    ...
    {
        if (spin_enemy_list[l]->EnemyDead && spin_enemy_list[l]->DeathAnimationCounter < 30)
        {
            spin_enemy_list[l]->DeathAnimationRender(renderer);
            l++;
        }
        else if (spin_enemy_list[l]->EnemyDead)
        {
